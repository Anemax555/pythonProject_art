...
def article_get(t):
    ...
    params = (uid, title, art, furl, sourTime, url, f_inputTime, img_list, furl, furl)
    input_mysql(params)
    input_redis(url)
    # print(img_list)
    # print(params)
...
# url = [{'furl':'111','url':'https://caifuhao.eastmoney.com/news/20220508210054942412740'}]
# page_index_get(url)
